<template>
		...
		<div class="uk-position-bottom-center uk-position-small uk-visible@m uk-position-z-index">
			<span class="uk-text-small uk-text-muted">© 2021 GENCO Industry - <a href="https://www.ismarty.pro">Created by iSmartyPro</a></span>
		</div>
		<div class="uk-width-medium uk-padding-small uk-position-z-index" uk-scrollspy="cls: uk-animation-fade">
			...
			<!-- login -->
			<form class="toggle-class" action="login-dark.html" @submit.prevent="onSubmit">
            ...
            .then(
                user => {
									if(user) {
										...
										this.error = "Authetication failed"
